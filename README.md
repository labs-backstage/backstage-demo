...
Fork the following repo `https://github.com/labs-backstage/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/labs-backstage/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/labs-backstage/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/cluster-r9glr.r9glr.sandbox317.opentlc.com/${base_domain}/g" {} +
git add -A
...
Fork the following repo `https://github.com/labs-backstage/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/labs-backstage/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/labs-backstage/backstage-app-demo` to your organization.
